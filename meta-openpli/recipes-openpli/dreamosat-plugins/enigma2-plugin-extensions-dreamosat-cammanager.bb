DESCRIPTION = "Extensions: DreamOSat camManager (BTKcam, GCam, NCam, OSCam, OSCamYmod, CCcam, MgCamd, WiCardd)"
SUMMARY = " Enigma2 Plugin DreamOSat camManager For Images by audi06_19"
...
# RDEPENDS:${PN} = "${PN}"
# RRECOMMENDS:${PN} = "${PN}"
PACKAGES = "enigma2-plugin-extensions-dreamosat-cammanager"
PROVIDES = "${PACKAGES}"

PV = "git${SRCPV}"
PKGV = "git${GITPKGV}"

LOCAL_FILES = "DreamOSatcamManager"
