DESCRIPTION = "Extensions DreamOSat Script For E2 Images : console bash shell script"
SUMMARY = " Enigma2 Plugin DreamOSat Script For Images by audi06_19"
...
# DEPENDS = ""
RDEPENDS:${PN} = "p7zip curl"
# RRECOMMENDS:${PN} = "${PN}"
PACKAGES = "enigma2-plugin-extensions-dreamosat-script"
PROVIDES = "${PACKAGES}"

PV = "git${SRCPV}"
PKGV = "git${GITPKGV}"

LOCAL_FILES = "DreamOSatScript"
