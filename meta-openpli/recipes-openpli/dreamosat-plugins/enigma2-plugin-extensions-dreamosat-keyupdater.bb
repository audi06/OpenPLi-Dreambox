DESCRIPTION = "Extensions DreamOSat keyUpdater For E2 All Images"
SUMMARY = " Enigma2 Plugin DreamOSat keyUpdater For Images by audi06_19"
...
# RDEPENDS:${PN} = "${PN}"
# RRECOMMENDS:${PN} = "${PN}"
PACKAGES = "enigma2-plugin-extensions-dreamosat-keyupdater"
PROVIDES="${PACKAGES}"

PV = "git${SRCPV}"
PKGV = "git${GITPKGV}"

LOCAL_FILES = "DreamOSatkeyUpdater"
