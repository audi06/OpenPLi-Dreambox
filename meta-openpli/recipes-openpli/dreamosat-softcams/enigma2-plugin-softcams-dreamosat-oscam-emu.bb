...
"
LICENSE = "CLOSED"
PACKAGES = "enigma2-plugin-softcams-dreamosat-oscam-emu"
PROVIDES = "${PACKAGES}"
...
SRC_URI += "https://raw.githubusercontent.com/oscam-emu/oscam-emu/master/oscam-emu.patch;downloadfilename=oscam-emu.patch;name=emu;striplevel=0"
...
do_install() {
	...
	install -m 0644 ${WORKDIR}${CONF_FILES2}/* ${D}${sysconfdir}/tuxbox/config
	install -d ${D}${bindir}
